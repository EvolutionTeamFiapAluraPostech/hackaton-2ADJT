package br.com.fiap.payments.infrastructure.security;

import static org.springframework.http.HttpMethod.GET;
import static org.springframework.http.HttpMethod.PATCH;
import static org.springframework.http.HttpMethod.POST;

import br.com.fiap.payments.infrastructure.handler.CustomAccessDeniedHandler;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http.csrf(AbstractHttpConfigurer::disable)
        ...
        .authorizeHttpRequests(req -> {
          req.requestMatchers(POST, URL_PAYMENTS).authenticated();
          req.requestMatchers(GET, URL_PAYMENTS + "/**").authenticated();
