...
import static br.com.fiap.payments.domain.valueobject.Cpf.CPF_INVALID;
import static br.com.fiap.payments.domain.valueobject.Cpf.CPF_LENGTH_INVALID_MESSAGE;
import static br.com.fiap.payments.domain.valueobject.Cpf.CPF_NOT_EMPTY_MESSAGE;
import static br.com.fiap.payments.domain.valueobject.Cpf.CPF_NOT_NULL_MESSAGE;
...
class CpfTest {
  ...
  void shouldValidateCpfNumberWhenCpfNumberIsValid() {
    var cpf = new Cpf(DEFAULT_PAYMENT_CPF);

    assertThat(cpf).isNotNull();
    assertThat(cpf.getCpfValue()).isNotNull().isNotEmpty();
    assertThat(cpf.getCpfValue()).isEqualTo(DEFAULT_PAYMENT_CPF);
  }
}
